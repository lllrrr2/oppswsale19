...
cp ../zzz-default-settingsk2pbuy package/lean/default-settings/files/zzz-default-settings
sed -i "s/8.3.19.0410/K9.$(date "+%y.%m%d.%H")/g" package/lean/default-settings/files/zzz-default-settings
sed -i "s/8.3.19.0410/K9.$(date "+%y.%m%d.%H")/g" files/etc/banner
